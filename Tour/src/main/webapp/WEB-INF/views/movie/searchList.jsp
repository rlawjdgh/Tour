	...
	$.ajax({
		...
		success:function(data){
			...
			$.each(data.movieListResult.movieList,function(index,item){ 
				str+="<div class='card mb-3'><div class='row no-gutters'>";
				str+="<div class='col-md-2'><img src='...' class='card-img' alt='...'></div>";
				str+="<div class='col-md-5'><div class='card-body'>";
				str+="<h5 class='card-title'>"+ item.movieNm + "(" + item.movieNmEn +")" + "</h5>";
				...
				str+="</div></div>";
				str+="</div>";
				//str+="<button class='btn btn-primary col-md-2' onClick='" + show(item.movieCd) + ";'>상세보기</button></div></div>";				
			});
			$(".result").append(str);
		},
		error:function(){
...
<div class="container mt-5">
	<p>"${keyword }" 검색결과</p>
	<div class="result justify-content-center"></div>
</div>
</body>
</html>